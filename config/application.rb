...
module BootstrapStarter
  class Application < Rails::Application
    ...
    config.assets.precompile += %w( about.css explore_data.css faqs.css fonts_en.css fonts_ka.css laws.css news.css publications.css root.css stories.css stories_admin.css variable.css )    
