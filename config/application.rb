...
module BootstrapStarter
  class Application < Rails::Application
    ...
    config.assets.precompile += %w( explore_data.js faqs.js game.js game-summary.js laws.js news_items.js publications.js root.js stories_admin.js)
    config.assets.precompile += %w( about.css explore_data.css faqs.css fonts_en.css fonts_ka.css laws.css news.css publications.css root.css stories.css stories_admin.css variables.css )    
