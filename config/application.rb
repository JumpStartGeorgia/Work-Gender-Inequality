...
module BootstrapStarter
  class Application < Rails::Application
    ...
    config.assets.precompile += %w( explore_data.js faqs.js game.js game-summary.js laws.js news_items.js publications.js)
    config.assets.precompile += %w( explore_data.css faqs.css laws.css news.css publications.css root.css stories.css )    
