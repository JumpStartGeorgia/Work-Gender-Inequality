...
class FaqsControllerTest < ActionController::TestCase
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post :create, faq: { answer: @faq.answer, faq_category_id: @faq.faq_category_id, question: @faq.question, sort: @faq.sort }
    end
  ...
  test "should update faq" do
    put :update, id: @faq, faq: { answer: @faq.answer, faq_category_id: @faq.faq_category_id, question: @faq.question, sort: @faq.sort }
    assert_redirected_to faq_path(assigns(:faq))
  end
