module ActiveRecord
  class Base
    #############################################
    ## taken from: http://ursdiganta.blogspot.com/2011/07/mysql2-and-stored-procedures-in-rails-3.html
    ## mysql2/rails does not work nicely with stored procedures so this helps it
    #############################################
    ...
    # @return [Hash]
    #
    def self.call_sproc(sql, name = nil)
